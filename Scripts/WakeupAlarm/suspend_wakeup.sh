...
echo "${min} ${hour} * * * jensjp /home/jensjp/Scripts/TapoScripts/venv/bin/python3 /home/jensjp/Scripts/TapoScripts/wakeup_light.py" | sudo tee /etc/cron.d/wakeup_light
