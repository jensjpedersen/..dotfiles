...
# ========================= Options =========================
set autopushd               # Push directory onto directory stack 
set pushdignoredups         # Dont push multiple copies of the some directory onto the directory stack
...
#  #local ret=$?
#  #zle reset-prompt
#  echo $(fd -H -t file . --search-path ~ | fzf)
#  
#  
#}
#zle     -N   fzf-file
...
#  #local ret=$?
#  #zle reset-prompt
#  echo $(fd -H -t directory . --search-path ~ | fzf)
#  
#  
#}
#zle     -N   fzf-directory
...
# ========================= print on start =========================
#
(( $SHLVL == 1 )) && task next && timew summary day
